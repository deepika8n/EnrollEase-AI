...
function pickStudentDbColumns(student: Record<string, unknown>) {
  return {
    ...
    photo_preview_url: sanitizeString(student.photo_preview_url),
    aadhaar_preview_url: sanitizeString(student.aadhaar_preview_url),
  ...
  try {
    ...
    if (action === "submit_request") {
      ...
      const nextStudentPayload = pickStudentDbColumns({
        ...
        photo_preview_url: sanitizeString(studentPatch.photo_preview_url),
        aadhaar_preview_url: sanitizeString(studentPatch.aadhaar_preview_url),
